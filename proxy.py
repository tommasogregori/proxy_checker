...
import time, itertools, threading, queue
from colorama import Fore, Back, Style

in_directory = input(str("In which directory is the proxy located? (Just the folder's directory), call the proxy file 'proxy.txt' "
out_filename = 'tested.txt'
